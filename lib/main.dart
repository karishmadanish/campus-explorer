...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = campusExplorerFirebaseUserStream()
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        selectedBackgroundColor: FlutterFlowTheme.of(context).primaryText,
        borderRadius: 50.0,
        ...
        items: [
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 0 ? Icons.add_home : Icons.home,
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 2 ? Icons.person_add : Icons.person,
