...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Version',
          path: '/version',
          builder: (context, params) => const VersionWidget(),
        ),
        FFRoute(
          name: 'Trial',
          path: '/trial',
          builder: (context, params) => const TrialWidget(),
        ),
        FFRoute(
          name: 'About',
          path: '/about',
        ...
        FFRoute(
          name: 'TourForm',
          path: '/tourForm',
          builder: (context, params) => const TourFormWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/lv_0_20240413160820.gif',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
