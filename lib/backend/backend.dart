...
import 'schema/campus_tour_record.dart';
...
export 'schema/campus_tour_record.dart';
...
/// Functions to query CampusTourRecords (as a Stream and as a Future).
Future<int> queryCampusTourRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CampusTourRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CampusTourRecord>> queryCampusTourRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CampusTourRecord.collection,
      CampusTourRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CampusTourRecord>> queryCampusTourRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
